...
export function HeaderBt() {
  return (
    <nav className="navbar navbar-expand-lg shadow-lg   bg-zinc-800 relative flex items-center w-full justify-between border-t-4 border-red-600 pl-32">
        ...
        <div className="navbar-collapse collapse  grow items-center" id="navbarSupportedContentX">
          <ul className="navbar-nav mr-auto flex flex-row">
            ...
            <li className="nav-item dropdown static border-x border-slate-700">
              ...
              <div className="dropdown-menu w-70 mt-0 hidden shadow-lg bg-slate-800 absolute left-44 top-full " aria-labelledby="dropdownMenuButtonX">
            ...
            <li className="nav-item dropdown static border-r border-slate-700 ">
              ...
              <div className="dropdown-menu w-70 mt-0 hidden shadow-lg bg-slate-800 absolute left-56 top-full " aria-labelledby="dropdownMenuButtonX">
                <div className="px-6 lg:px-8 py-5">
            ...
            <li className="nav-item dropdown static border-r border-slate-700 ">
              ...
              <div className="dropdown-menu w-70 mt-0 hidden shadow-lg bg-slate-800 absolute left-4 top-full " aria-labelledby="dropdownMenuButtonX">
                <div className="px-6 lg:px-8 py-5">
                  <div className="grid md:grid-cols-2 lg:grid-cols-1 ">
                    <div className="bg-slate-800 text-white ">
                      <a href="#!" aria-current="true" className="block py-2 border-b border-slate-700 w-full hover:bg-gray-50 hover:text-gray-700 transition duration-150 ease-in-out">Thông tin chung</a>
